# Generated by Powerlevel10k configuration wizard on 2024-08-06 at 09:12 +03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    cc                      # C/C++ compiler (shows a symbol when $CC is set)
    sdk_sysroot
    time                    # current time
  ...
  ###############################################################################
  # Show a symbol when CC is set
  function prompt_cc() {
    [[ -n $CC ]] || return
    p10k segment -i '🛠' -f 208
  }

  function prompt_sdk_sysroot() {
    [[ -n $SDK_SYSROOT ]] || return
    p10k segment -i '📦' -f 208
  }
  ###############################################################################
  # My customizations end here.                                                 #
  ###############################################################################
